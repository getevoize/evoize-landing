<template>
  <section class="mx-auto mb-40 mt-20 max-w-3xl space-y-8 px-4">
    ...
    <p class="text-center text-xl text-gray-600">
      ...
      Rechnungen zu generieren und sofort an Kunden zu senden. Dies beschleunigt
      den Zahlungseingang und verbessert Ihren Cashflow.
    </p>
    ...
    >
      ...
      />
      <h3 class="text-left text-4xl font-bold text-blue-500">
